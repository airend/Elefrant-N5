...
enum msm_vidc_extradata_type_ { /* Legacy enumeration */
	EXTRADATA_NONE = MSM_VIDC_EXTRADATA_NONE,
	EXTRADATA_MB_QUANTIZATION = MSM_VIDC_EXTRADATA_MB_QUANTIZATION,
	EXTRADATA_INTERLACE_VIDEO = MSM_VIDC_EXTRADATA_INTERLACE_VIDEO,
	EXTRADATA_VC1_FRAMEDISP = MSM_VIDC_EXTRADATA_VC1_FRAMEDISP,
	EXTRADATA_VC1_SEQDISP = MSM_VIDC_EXTRADATA_VC1_SEQDISP,
	EXTRADATA_TIMESTAMP = MSM_VIDC_EXTRADATA_TIMESTAMP,
	EXTRADATA_S3D_FRAME_PACKING = MSM_VIDC_EXTRADATA_S3D_FRAME_PACKING,
	EXTRADATA_FRAME_RATE = MSM_VIDC_EXTRADATA_FRAME_RATE,
	EXTRADATA_PANSCAN_WINDOW = MSM_VIDC_EXTRADATA_PANSCAN_WINDOW,
	EXTRADATA_RECOVERY_POINT_SEI = MSM_VIDC_EXTRADATA_RECOVERY_POINT_SEI,
	EXTRADATA_MPEG2_SEQDISP = MSM_VIDC_EXTRADATA_MPEG2_SEQDISP,
	EXTRADATA_STREAM_USERDATA = MSM_VIDC_EXTRADATA_STREAM_USERDATA,
	EXTRADATA_FRAME_QP = MSM_VIDC_EXTRADATA_FRAME_QP,
	EXTRADATA_FRAME_BITS_INFO = MSM_VIDC_EXTRADATA_FRAME_BITS_INFO,
	EXTRADATA_INPUT_CROP = MSM_VIDC_EXTRADATA_INPUT_CROP,
	EXTRADATA_DIGITAL_ZOOM = MSM_VIDC_EXTRADATA_DIGITAL_ZOOM,
	EXTRADATA_MULTISLICE_INFO = MSM_VIDC_EXTRADATA_MULTISLICE_INFO,
	EXTRADATA_NUM_CONCEALED_MB = MSM_VIDC_EXTRADATA_NUM_CONCEALED_MB,
	EXTRADATA_INDEX = MSM_VIDC_EXTRADATA_INDEX,
	EXTRADATA_ASPECT_RATIO = MSM_VIDC_EXTRADATA_ASPECT_RATIO,
	EXTRADATA_METADATA_FILLER = MSM_VIDC_EXTRADATA_METADATA_FILLER,
	EXTRADATA_METADATA_LTR = MSM_VIDC_EXTRADATA_METADATA_LTR,
	EXTRADATA_METADATA_MBI = MSM_VIDC_EXTRADATA_METADATA_MBI,
	EXTRADATA_VUI_DISPLAY_INFO = MSM_VIDC_EXTRADATA_VUI_DISPLAY_INFO,
};
...
enum msm_vidc_interlace_type_ { /* Legacy enumeration */
	INTERLACE_FRAME_PROGRESSIVE = MSM_VIDC_INTERLACE_FRAME_PROGRESSIVE,
	INTERLACE_INTERLEAVE_FRAME_TOPFIELDFIRST = MSM_VIDC_INTERLACE_INTERLEAVE_FRAME_TOPFIELDFIRST,
	INTERLACE_INTERLEAVE_FRAME_BOTTOMFIELDFIRST = MSM_VIDC_INTERLACE_INTERLEAVE_FRAME_BOTTOMFIELDFIRST,
	INTERLACE_FRAME_TOPFIELDFIRST = MSM_VIDC_INTERLACE_FRAME_TOPFIELDFIRST,
	INTERLACE_FRAME_BOTTOMFIELDFIRST = MSM_VIDC_INTERLACE_FRAME_BOTTOMFIELDFIRST,
};
...
enum msm_vidc_recovery_sei_ { /* Legacy enumeration */
	FRAME_RECONSTRUCTION_INCORRECT = MSM_VIDC_FRAME_RECONSTRUCTION_INCORRECT,
	FRAME_RECONSTRUCTION_CORRECT = MSM_VIDC_FRAME_RECONSTRUCTION_CORRECT,
	FRAME_RECONSTRUCTION_APPROXIMATELY_CORRECT = MSM_VIDC_FRAME_RECONSTRUCTION_APPROXIMATELY_CORRECT,
};
